...
load(here("data/working/rd_pre_covid_features.RData"))
...
ci <- here::here("data/working/rd_ci_final.feather") |>
...
last_queried <- file.info(here::here("data/raw/rd_rpd_sample_ci.csv")) |>
  pluck("mtime") |>
  as_date()
...
if(!test) write_feather(outcomes, here("data/working/rd_monthly_outcomes.feather"))
