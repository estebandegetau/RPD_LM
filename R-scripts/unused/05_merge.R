...
load(here("data/working/rd_unemployment.RData"))
...
features <- here("data/raw/rd_rpd_sample.csv") |>
...
# work |> pull(account_days) |> summary()

# work |> pull(account_days) |> length()


# work |>
#     filter(
#         .by = CVE_NSS,
#         any(is.na(account_days))
#     ) |>
#     filter(CVE_NSS == first(CVE_NSS)) |>
...
save(workers, file = here("data/anon/rd_workers.RData"))

save(description, file = here("data/anon/rd_description.RData"))

save(keys, file = here("data/working/rd_keys.RData"))

write_csv(keys, here("data/working/rd_keys.csv"))
